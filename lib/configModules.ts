...
export const CONFIG_MODULES: ConfigModule[] = [
  ...
  { key: 'asset-register',        href: '/admin/asset-register',        icon: '📋', title: 'Asset Register Access',      desc: 'Who can open the full asset register and request protection changes.',                     group: 'access',       color: '#0078D4', keywords: ['asset', 'register', 'protection', 'request', 'table'] },
