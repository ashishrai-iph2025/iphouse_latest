...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'Per-report embed authorisation', desc: 'Implement granular per-report access control. Currently: authenticated users can access all reports. Needed: client-based or explicit report assignment model.', prio: 'Priority 2', pk: 'p2' },
